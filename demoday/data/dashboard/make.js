...
var price = [0,-95, -30, -65, -35, -215, -95, -70, -100, -20, -40, -60, -80, -random100];
...
var currentBal = (price[price.length-1])*-1;

var checkings = Math.round(100*(currentBal*(180/300)))/100;
var savings = Math.round(100*(currentBal*(46/300)))/100;
var credit = Math.round(100*(currentBal*(74/300)))/100;

document.getElementById("currentbal").innerHTML = "$" + currentBal;

document.getElementById("checkings").innerHTML = "$" + checkings;
